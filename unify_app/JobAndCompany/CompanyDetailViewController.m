...
@property (weak, nonatomic) IBOutlet UITextView *companyDetailTextView;
...
- (void)viewDidLoad {
    ...
    [self.companyDetailTextView sizeToFit];
    [self.companyDetailTextView  setText:self.currentCompany.companyDescription];
